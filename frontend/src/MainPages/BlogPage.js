    ...
    return(
        ...
        style = {{backgroundImage: `url('https://wallpaperaccess.com/full/3401965.jpg')`}}>
            ...
            <div className="flex align-middle justify-center flex-col items-center w-screen">
                ...
                <Card className="bg-cover bg-center flex flex-col gap-2 justify-center items-center h-fit rounded-none overflow-hidden border-b-black border-b-4 pt-5 pb-10 text-white" 
            ...
            <div>
                <Card className="bg-inherit flex flex-row gap-5 justify-center w-full py-5 rounded-t-none rounded-b-lg border-y-black border-y-4 text-white">
